...
| Dependency fetcher and management  | Yes :+1:  | Groovy   :white_check_mark:, Yaml  :white_check_mark: | :white_check_mark: |
| Init Web (*Composer*) with a REPO script file | Yes :+1:  | Groovy   :white_check_mark:, Yaml  :white_check_mark: | :white_check_mark: |  
| Validate syntax  | Yes :+1:  | Groovy   :white_check_mark:, Yaml  :x: | :x: |  
