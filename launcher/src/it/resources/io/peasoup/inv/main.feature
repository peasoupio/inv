Feature: What is the stdout of my main cli options?
  ...
  Scenario Outline: Main with cli options has stdout
    ...
    Examples:
      ...
      | -s run main1.groovy                                                     | file:/run              | 0        | /io/peasoup/inv/main/run/stdout2.txt               |
      ...
      # Repo
      | -x repo-get -rc url:/peasoupio/inv-public-repo/master/net/http/repo.yml | file:/repo/get         | 0        | /io/peasoup/inv/main/repo/stdout1.txt              |
      | -d repo-get -rc url:/peasoupio/inv-public-repo/master/net/http/repo.yml | file:/repo/get         | 0        | /io/peasoup/inv/main/repo/stdout2.txt              |
      | repo-create                                                             | file:/repo             | 0        | /io/peasoup/inv/main/repo/stdout3.txt              |
      | repo-run -l file:/repo/list/list.json                                   | file:/repo/list        | 0        | /io/peasoup/inv/main/repo/list/stdout4.txt         |
